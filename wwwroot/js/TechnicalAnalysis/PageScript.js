import { CandlestickKuCoin, calculateSMA, calculateEMA, calculateRSI, calculateMACD, calculateBollingerBands, TechnicalAnalysis } from "./Classes/CandlestickClassKuCoin.js";
...
function BtnActions() {
    GetAPI(Math.floor((Date.now() - 86400000) / 1000), Math.floor(Date.now() / 1000));
}
